...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_lisays_ostoskorissa_kaksi_ostosta(self):
        ...
        self.assertEqual(len(self.kori._ostoskori), 2)

    def test_kahden_saman_tuotteen_lisays_ostoskorissa_yksi_ostos(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_kahden_saman_tuotteen_lisays_yksi_tuotenimi_kaksi_tuotetta(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_lisataan_poistetaan_ostoskori_tyhja(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
